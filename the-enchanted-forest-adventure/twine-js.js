(function () {
  ...
  !(function () {
    ...
    (require = function (i) {
      var n = e[i];
      return (
        n && ((r[i] = n[1].apply(void 0, n[0].map(require))), (e[i] = void 0)),
        r[i]
      );
    }),
  ...
  define(
        ...
        if (
          ...
          for (
            ...
            (e[e.length - 1] = Object.create(o)),
              (e = e[e.length - 1].children = o.children.slice());
          e.push(r);
        }
      }
      function n(e) {
        var t,
          ...
          n = n.time,
          d =
            (i.findAndFilter("tw-enchantment").each(function (e, t) {
            ...
            o.children(M).not(".transition-out, .transition-out *")),
          a = (a.get("tags") || []).join(" "),
          f =
            ((t = N("<tw-passage><tw-sidebar>")),
            (f = t.children("tw-sidebar")),
            (h = N(
            ...
            P.pastLength <= 0 && h.css("visibility", "hidden"),
            P.futureLength <= 0 && g.css("visibility", "hidden"),
            f.append(h, g),
            t),
          h =
            ("function" == typeof u && (u = u.call(d)),
            "function" == typeof p && (p = p.call(f)),
            !s && c),
          m = h && d.css("width"),
          g =
            (j.detachStoryElement(),
            f.appendTo(o).attr({ tags: a }),
            h &&
              (D(d, c, n, 0, 0, 0, u),
              d.css({
                position: "absolute",
        ...
        if (P.pastLength <= 0 && 1 === P.turns) {
          var b,
            v = _createForOfIteratorHelper(I.getTagged("startup"));
          try {
          ...
          if (F.debug) {
            var w,
              k = _createForOfIteratorHelper(I.getTagged("debug-startup"));
            try {
        ...
        var S,
          T = _createForOfIteratorHelper(I.getTagged("header"));
        try {
        ...
        if (F.debug) {
          var _,
            x = _createForOfIteratorHelper(I.getTagged("debug-header"));
          try {
        ...
        L(y, e);
        var O,
          A = _createForOfIteratorHelper(I.getTagged("footer"));
        try {
        ...
        if (F.debug) {
          var C,
            E = _createForOfIteratorHelper(I.getTagged("debug-footer"));
          try {
        ...
        g.renderInto(y, f, {
          ...
          (g.loadedGame = !1),
          j.reattachStoryElement(),
          scroll(
            0,
            s
              ? f.offset().top - 0.05 * N(window).height()
              : o[0].getBoundingClientRect().top + document.body.scrollTop
          );
      }
      ...
      function (
        ...
        !(function (o) {
          window.onerror = function (e, t, n, r, a) {
            (window.onerror = o),
              Utils.storyElement.parent().append(
                dialog({
                  message:
          ...
          Utils.onStartup(function () {
            ...
            0 !== a.length &&
              ...
              (a.attr("tags") || "").split(/\s/).forEach(function (e) {
                ("uncompressed-pure-values" !== e &&
                  "uncompressed-saves" !== e) ||
                  (Utils.options.uncompressedPureValues = !0),
                  ("uncompressed-structures" !== e &&
                    "uncompressed-saves" !== e) ||
                    (Utils.options.uncompressedStructures = !0);
              }),
                    ...
                    (!0 === (null == (t = e[o]) ? void 0 : t.spreader)
                      ? ((n = t.value),
                        (r = v.containsError(n))
                          ...
                          ? a.push.apply(
                              a,
                              _toConsumableArray(Array.from(n).sort(g("en")))
                            )
                          : a.push(
                              v.create(
                                "operation",
          ...
          for (
            ...
            if (
              (!(p = p || i).innerType ||
                ...
                ((i = p.innerType), "rest" === p.pattern && (p = p.innerType)),
              !(function e(t, n) {
                if (null === n) return void 0 === t;
                var r = _typeof(t);
                if ("function" != typeof n && n.pattern) {
                  if ("optional" === n.pattern || "zero or more" === n.pattern)
              ...
              return void 0 === l
                ? ((u = f.filter(function (e) {
                    return !(
                      "optional" === e.pattern || "zero or more" === e.pattern
                    );
                  }).length),
                  v.create(
                    "datatype",
          ...
          TypeSignature: {
            ...
            numberRange: function () {
              ...
              return {
                ...
                range: function (e) {
                  return (
                    "number" == typeof e && !Number.isNaN(e) && t <= e && e <= n
                  );
                },
              };
            },
          ...
          m = d(new Map(), {
            ...
            getTree: function (e) {
              ...
              if (
                ...
                return t.tree || (t.tree = c.lex(t.get("source"), e)), t.tree;
              for (var r, a = 0; a < i.length; a += 1)
                if (i[a] && i[a].place === e)
                  return (r = i.splice(a, 1)[0]), i.unshift(r), r;
    ...
    define(
      ...
      function (a, e, S, T) {
        ...
        function E(m, g) {
          ...
          if (m)
            for (
              var e, w = (m = Array.isArray(m) ? m : [m]).length, k = 0;
              k < w;
              k += 1
            )
              if (
                  ...
                  switch (n.type) {
                    case "include":
                      b += y(
                        n,
                        "tw-" + n.type,
                        'type="'.concat(n.tag, '" name="').concat(n.name, '"')
                      );
                      break;
                    case "error":
                      b += T.create("syntax", n.message, n.explanation).render(
                        _(n.text)
                      )[0].outerHTML;
                      break;
                    case "numbered":
                      ...
                      for (
                        ...
                        if ("br" === m[e].type) {
                          ...
                          m[e].type === n.type
                            ? ((b =
                                (b += ("<" + t + ">").repeat(
                                  Math.max(0, m[e].depth - r)
                                )) +
                                ("</" + t + ">").repeat(
                                  Math.max(0, r - m[e].depth)
                                ) +
                                "<li>"),
                              (r = m[e].depth))
                            : (b += E([m[e]], g));
                    ...
                    case "tag":
                      ...
                      /^<\/?(?:table|thead|tbody|tr|tfoot|td|th|svg)\b/.test(
                        ...
                        !n.text.endsWith("/>") &&
                        v[n.text.startsWith("</") ? "shift" : "unshift"](d),
                        (b += n.text.startsWith("</")
                          ? n.text
                          : n.text.replace(/(\/)?>$/, function (e, t) {
                              return " data-raw".concat(
                                t ? "></".concat(n.text.match(/[\w-]+/)) : "",
                                ">"
                              );
                            }));
                      break;
                    ...
                    case "macro":
                      ...
                      d = f.map(function (e) {
                        return (
                          (e.blockerTree = g.blockers.length),
                          g.blockers.push(e),
                          e.blockerTree
                        );
                      });
      ...
      function (p, f, a, u, r, e, t, i, d, h, o, m, g, y, b, v) {
        ...
        function A(e, t, n) {
          if (t && "object" === _typeof(t) && d.isPrototypeOf(t)) {
            var r =
              ...
              o = t.run(a);
            if (
              (b.containsError(o) && e.replaceWith(o.render(e.attr("title"))),
              !this.renderInto(r, null, a))
            )
              return (
                (o = f.insensitiveName(e.attr("name"))),
                ["if", "elseif", "unless", "else", "testfalse"].includes(o) &&
                  (e.addClass("false"), "elseif" !== o) &&
                    ...
                    function a(e) {
                      p &&
                        (d -=
                          (e - p) *
                          (f.options.debug &&
                          void 0 !== f.options.speedMultiplier
                            ? f.options.speedMultiplier
                            : 1)),
                        (p = e),
                      ...
                      i.inDOM() &&
                        ...
                        b.containsError(e)
                          ...
                          : (i.renderInto(l, r, n, u),
                            e ||
                              r.find("tw-expression[name='stop']").length ||
        ...
        function c(e, t) {
          ...
          e.append(E(this.evalReplay)),
            e.append(
              (function (e, t) {
                if (
                  /a \((go-to|undo|redirect|restart):\) command/.exec(
                    null == t ? void 0 : t.TwineScript_TypeName
                  )
                )
                  return p("<tw-open-button goto label='GO'>").data("goto", {
                    section: e,
                    command: t,
                  });
              })(this, n)
            ...
            this.stackTop.evaluateOnly &&
              ...
              (n = b.create(
                ...
                "I can't work out what "
                  ...
                  .concat(d.isPrototypeOf(n) ? "changer." : "command."),
          ...
          for (i = e; d.isPrototypeOf(n); ) {
            ...
            if (
              ...
              if ((i = s.nextElem).is("tw-expression")) {
                var s =
                    i.popData("code") ||
                    (null == (s = i[0]) || null == (s = s.cachedData)
                      ? void 0
                      : s.code),
                  l =
                    (null != (l = i[0]) &&
            ...
            if (i.is("tw-expression")) {
              (c =
                i.popData("code") ||
                (null == (a = i[0]) || null == (a = a.cachedData)
                  ? void 0
                  : a.code)),
                (s =
                  (null != (l = i[0]) &&
              ...
              if (
                s &&
                "object" === _typeof(s) &&
                "function" == typeof s.TwineScript_Attach
              ) {
                n = s.TwineScript_Attach(this, n);
                break;
              }
              return d.isPrototypeOf(s)
                ? void e.replaceWith(
                    b
                      .create(
                        "operation",
                ...
                : void e.replaceWith(
                    b
                      .create(
                        "operation",
                        ""
                          .concat(k(s), " can't have changers like (")
                          .concat(n.macroName, ":) attached."),
            ...
            n.macroName ||
              f.impossible("Section.runExpression", "changer has no macroName");
          ...
          e.attr("return", S(n)),
            ...
            (t = b.containsError(n))
              ? e.replaceWith(
                  t.render(e.attr("title")).append(E(this.evalReplay))
                )
              : v.isPrototypeOf(n)
              ? e.append(n.render())
              ...
              : (r.length && A.call(this, e, n, r)) ||
                ...
                m.isPrototypeOf(n) ||
                (n &&
                  "function" == typeof n.TwineScript_Print &&
                  !d.isPrototypeOf(n))
                  ? ((n = w(n)),
                    b.containsError(n)
                      ? e.replaceWith(n.render(e.attr("title")))
                  ...
                  : d.isPrototypeOf(n) ||
                    ...
                    f.impossible(
                      "Section.runExpression",
                      "The expression evaluated to an unknown value: ".concat(n)
                    ));
        }
        var l = { add: [], remove: [] };
        return Object.preventExtensions({
          ...
          renderInto: function (e, a, t) {
            ...
            if (O(i.loopVars).length) {
              ...
              if (
                ...
                for (var u = l - 1; 0 <= u && !this.stackTop.blocked; --u)
                  this.execute();
              }
              ...
              n
                ...
                .each(function (e, t) {
                  ...
                  switch ((n && (t.cachedData = void 0), (t = p(t)).tag())) {
                    case "tw-hook":
                      var r =
                        t.popData("source") || (null == n ? void 0 : n.source);
                    ...
                    case "tw-expression":
                      var r =
                        t.data("blockers") || (null == n ? void 0 : n.blockers);
                      if (r) {
                        if (o)
                          return void t
                            .removeData("blockers")
                        ...
                        if (r.length)
                          return (
                            ...
                            b.containsError(r) &&
                              ...
                              t
                                .removeData("blockers")
                                .replaceWith(r.render(t.attr("title"), t))),
                            !1
                          );
          ...
          unblock: function (e) {
            for (
              this.stack.length ||
                f.impossible("Section.unblock", "stack is empty"),
    ...
    define(
      ...
      function (n, y, b, v, e, t) {
        ...
        function r(e, t) {
          for (
            var n, r = t.variables, a = h(null), o = e.length - 1;
            0 <= o;
            --o
          ) {
            for (
            ...
            for (i in (c.forgetVisits &&
              (t.forgetVisits = Math.max(t.forgetVisits || 0, c.forgetVisits)),
            void 0 !== c.turns && (t.turns = (t.turns || 0) + c.turns),
            t.pastVisits || (t.pastVisits = []),
            o !== e.length - 1 &&
              (void 0 !== e[o + 1].visits && Array.isArray(t.pastVisits[0])
                ? t.pastVisits[0]
                : t.pastVisits
              ).unshift(c.passage),
            ...
            c.variables))
              if ("TwineScript_TypeDefs" === i)
                for (var d in (r[i] || (r[i] = h(null)), c.variables[i]))
            ...
            o(e.variables, {
              ...
              TwineScript_Set: function (e, t, n) {
                if (((this[e] = t), (d.variables[e] = t), n))
                  ...
                  (N(t) ||
                    ...
                    t instanceof Set ||
                    "string" == typeof t) &&
                  !y.options.uncompressedStructures
                )
                  for (var r = p; 0 <= r; --r) {
                    ...
                    if (void 0 !== a) {
                      a = (function e(t, n, r) {
                        ...
                        if (N(n) && N(t) && n.length) {
                          for (
                            var i = n.length === t.length, o = "(a:", s = 0;
                            s < n.length;
                            s += 1
                          ) {
                            var c,
                            ...
                            E(p, t[s])
                              ? ((c = C(p)),
                                (l = "".concat(a, " ").concat(s + 1, "th")),
                                (o += (c.length < l.length ? c : l) + ","))
                              : ((i = !1),
                                -1 < (c = t.indexOf(p))
                                  ? ((l = C(p)),
                                    (u = "".concat(a, " ").concat(c + 1, "th")),
                                    (o += (l.length < u.length ? l : u) + ","))
                                  : (o +=
                                      e(
                                        t[s],
                                        p,
                                        "".concat(a, " ").concat(s + 1, "th")
                                      ) + ","));
                          }
                          o = i ? r : o.slice(0, -1) + ")";
                        } else if (
                          ...
                          try {
                            for (h.s(); !(d = h.n()).done; ) {
                              ...
                              (o += "".concat(C(b), ",")),
                                E(v, t.get(b))
                                  ? ((m = C(v)),
                                    (g = "".concat(a, " (").concat(C(b), ")")),
                                    (o += (m.length < g.length ? m : g) + ","))
                                  : ((f = !1),
                                    (o +=
                                      e(
                                        t.get(b),
                          ...
                          "string" == typeof n &&
                            ...
                            n &&
                            (n.startsWith(t)
                              ? (o = r + "+" + C(n.slice(t.length)))
                              : n.endsWith(t) &&
                                (o =
                                  C(n.slice(0, n.length - t.length)) +
                                  "+" +
                                  r));
                        return o
                          ? "it" === r
              ...
              TwineScript_DefineType: function (e, t) {
                (this.TwineScript_TypeDefs[e] = t),
                  hasOwnProperty.call(d.variables, "TwineScript_TypeDefs") ||
                    (d.variables.TwineScript_TypeDefs = h(null)),
                ...
                if (hasOwnProperty.call(r[a], "at")) {
                  ...
                  if (void 0 !== l)
                    for (var h = 0, m = c - s; y.hash(f).toString(16) !== l; ) {
                      if (h + m >= d.length)
                        throw Error(
                          "The value (or type) of the variable `$"
                            .concat(a, "` couldn't be found in the passage `\"")
                            .concat(i, '"`.')
                        );
                    ...
                    void 0 !== o &&
                      ...
                      c.forEach(function e(t) {
                        ...
                        "string" !== t.type &&
                          ...
                          t.children.every(e),
                          "macro" !== t.type ||
                            ("prompt" !== (n = y.insensitiveName(t.name)) &&
                              "confirm" !== n) ||
                            (t.blockedValue = !0);
                      })),
                    (r[a] = e.eval(c));
                  ...
                  (r[a] = e.eval(k(r[a].via, "", "macro"))),
                    (e.Identifiers.it = 0);
                } else
                  hasOwnProperty.call(r[a], "changer") &&
                    ((r[a].changer = e.eval(k(r[a].changer, "", "macro"))),
                    (r[a].hook = e.eval(k(r[a].hook, "", "macro"))),
                    _(e, t, n, r[a].variables),
                    (r[a] = v.create(r[a])));
        ...
        return (
          ...
          ((a = {
            ...
            forgetUndos: function (e) {
              ...
              e.length &&
                ...
                (f = ""),
                0 === p &&
                  n("tw-link[undo], tw-icon[alt='Undo']", y.storyElement).each(
                    function (e, t) {
                      (
                        n(t)
            ...
            forgetVisits: function (e) {
              (e = e < 0 ? u.length + e : e) > p + i.turns && (e = p + i.turns),
                (d.forgetVisits = i.forgetVisits =
            ...
            rewind: function (e) {
              for (var t = void 0 !== e ? e : 1, n = !1; 0 < t && 0 < p; t--)
                (n = !0), --p;
              return (
                n &&
            ...
            fastForward: function (e) {
              var t = 1,
                n = !1;
              for ("number" == typeof e && (t = e); 0 < t && 0 < u.length; t--)
                (n = !0), (p += 1);
              return (
                n &&
                  (l.beforeForward.forEach(function (e) {
            ...
            on: function (e, t) {
              if (e in l)
                return (
                  "function" != typeof t || l[e].includes(t) || l[e].push(t), a
                );
            ...
            shuffled: function () {
              for (
                var a = this, e = arguments.length, t = new Array(e), n = 0;
                n < e;
                n++
              )
                t[n] = arguments[n];
          ...
          (a.deserialise = function (e, t) {
            ...
            for (var r = 0; r < n.length; r += 1) {
              ...
              if (
                ((a.valueRefs = h(null)),
                (a.variables = o(h(null), a.variables)),
                !b.hasValid(a.passage))
              )
                return Error(
                  'The data refers to a passage named `"'.concat(
                    a.passage,
              ...
              if (hasOwnProperty.call(a.variables, "TwineScript_TypeDefs"))
                try {
                  ...
                  return Error(
                    "The variable types on turn "
                      .concat(r + 1, " couldn't be reconstructed.")
    ...
    define("utils", ["jquery", "markup", "utils/polyfills"], function (d) {
      ...
      function y(n, r, e, a, o) {
        ...
        function l(e) {
          ...
          1 & n[0].compareDocumentPosition(document) && (c = 0),
            ...
            c <= r &&
              ((s += t || 0), "paused" === n.css("animation-play-state")) &&
              n.css({
                visibility: "",
          ...
          (c -= e = void 0 === e ? s : e),
            "running" === n.css("animation-play-state") &&
              n.css(
                "animation-delay",
                (("ms" ===
                (t = (t = n.css("animation-delay")).toLowerCase()).slice(-2)
                  ? +t.slice(0, -2) || 0
                  : ("s" === t.slice(-1) && 1e3 * +t.slice(0, -1)) || 0) || 0) -
                  e +
                  "ms"
              );
        }),
      ...
      var b = /-|_/g,
        v = {
          hash: function (e) {
            for (var t = 9, n = e.length; 0 < n; )
              --n, (t = Math.imul(t ^ e.charCodeAt(n), Math.pow(9, 9)));
            return (t ^ (t >>> 9)) >>> 0;
          },
              ...
              [].every.call(e.findAndFilter("*"), function (e) {
                if (
                  !(
                    ...
                    /display: (none|inline)/.test(e.getAttribute("style"))
                  )
                ) {
                  if (
          ...
          debounce: function (e) {
            function t() {
              300 < Date.now() - l || s <= u
                ? ((u = n = 0),
                  (p = !i),
                  o ? (e(c), (c = [])) : e.apply(void 0, _toConsumableArray(c)),
                  (p = !1))
            ...
            return function () {
              ...
              p ||
                ...
                (u += e - l),
                (l = e),
                o ? c.push(arguments) : (c = arguments),
                ...
                if (Array.isArray(i) && Array.isArray(t)) {
                  for (var s = 0, c = 0; s < t.length && c < i.length; ) {
                    var l = t[s],
                      u = i[c];
                    if (
                      (y.isPrototypeOf(l) && l.datatype.rest) ||
                      (b.isPrototypeOf(l) && l.rest)
                    ) {
                      for (var p = c; c < i.length && S(l, u); )
                        u = i[(c += 1)];
                      y.isPrototypeOf(l)
                        ? (l.datatype = [l.datatype])
                        : b.isPrototypeOf(l) && (l = b.create("array")),
                        (o = o.concat(
                          e(
                            l,
                            v.isPrototypeOf(n)
                              ? v.create(n, { first: p + 1, last: c + 1 })
                              : i.slice(p, c)
                          )
                        ));
                    } else
                      (o = o.concat(
                        e(l, v.isPrototypeOf(n) ? v.create(n, c + 1) : u)
                      )),
                        (c += 1);
                    s += 1;
                  }
                ...
                if (t instanceof Map && i instanceof Map) {
                  ...
                  try {
                    for (f.s(); !(d = f.n()).done; ) {
                      ...
                      o = o.concat(
                        e(g, v.isPrototypeOf(n) ? v.create(n, m) : i.get(m))
                      );
                    }
                  } catch (e) {
                    f.e(e);
        ...
        var i = e.plural,
          ...
          l = {
            ...
            TwineScript_Clone: function () {
              for (
                var e = l.create(this.macroName, this.params, this.next), t = e;
                t.next;
    ...
    define("datatypes/colour", ["jquery"], function (c) {
      ...
      function w(e, t) {
        for (
          var n = arguments.length, r = new Array(2 < n ? n - 2 : 0), a = 2;
          a < n;
          a++
        )
          r[a - 2] = arguments[a];
      ...
      function O(e) {
        ...
        (r[1] = (n[0] + 16) / 116),
          ...
          (r[2] = r[1] - n[2] / 200);
        (n = [
          i(r[0], 3) > T ? i(r[0], 3) : (116 * r[0] - 16) / S,
          S * T < t ? i((16 + t) / 116, 3) : t / S,
          i(r[2], 3) > T ? i(r[2], 3) : (116 * r[2] - 16) / S,
        ].map(function (e, t) {
          return e * k[t];
        })),
          (t = _slicedToArray(
      ...
      var A = Object.freeze({
        ...
        TwineScript_ToSource: function () {
          ...
          return "("
            ...
            .concat(
              this.lch ? [this.lch.l, this.lch.c, this.lch.h] : [e.h, e.s, e.l]
            )
          ...
          return "string" == typeof e
            ...
            ? (("a" in e && "number" == typeof e.a) || (e.a = 1),
              "h" in e && "c" in e && !("s" in e) && "l" in e
                ? g(y(this), { a: e.a, lch: { l: e.l, c: e.c, h: e.h } })
                : g(y(this), e))
            : this.create(
                ((a = (t = e).h),
                (o = e.s),
        ...
        isHexString: function (e) {
          return (
            "string" == typeof e &&
            "#" === e[0] &&
            (e.slice(1).match(b) || e.slice(1).match(t))
          );
        },
          ...
          return function (e) {
            ...
            for (var p = 0; p < l.length; p += 1) {
              var d = l[p],
                f = t[i],
                h =
                  ((a.TwineScript_TypeDefs[f] = n[i].datatype.rest
            ...
            if (!s && null != (g = n[i]) && g.datatype.rest) {
              ...
              g.set([]),
                (a.TwineScript_TypeDefs[name] = n[i].datatype.create("array"));
            }
            var y,
              g = w("<p>").append(k.exec(r.code)),
              b = e.stack.length,
              r =
                (e.stack.unshift({
                  tempVariables: a,
                ...
                e.evalReplay);
            for (e.evalReplay = null, e.execute(); e.stack.length > b; )
              e.stack.shift();
            e.evalReplay = r;
            r = g.find("tw-error");
            return r.length
      ...
      function (e, t, n, r, a, o, i, s, c) {
        var l = e.realWhitespace,
          ...
          y = {
            ...
            get TwineScript_ObjectName() {
              return (
                "the " + (this.rest ? "..." : "") + this.name + " datatype"
              );
            },
            TwineScript_is: function (e) {
            ...
            {},
            {
              ...
              empty: function (e) {
                return e instanceof Map || e instanceof Set
                  ? !e.size
                  : !((!Array.isArray(e) && "string" != typeof e) || e.length);
              },
              int: function (e) {
            ...
            return (
              ...
              e.stops.every(function (e, t) {
                var n = e.colour,
                  e = e.stop;
                return (
                  r.stops[t].stop === e && r.stops[t].colour.TwineScript_is(n)
                );
              })
            );
          },
              ...
              if ("lines" === e)
                return (
                  ...
                  n.contents().each(function e(t, n) {
                    ...
                    if ("tw-sidebar" !== r)
                      if ("tw-passage" === r || "tw-transition-container" === r)
                        g(n).contents().each(e);
                      else {
                        if (f.length) {
                  ...
                  g(
                    h
                      .map(function (e) {
                        return (
                          !!e.length &&
                          g(e).wrapAll("<tw-pseudo-hook>").parent()[0]
                        );
                      })
                      .filter(Boolean)
                  )
          ...
          if (this.selector) {
            if ("string" === this.selector.type)
              ...
              if ("base" === this.selector.type)
                return o.add(t(l.call(this.selector.data, e), this.property));
        ...
        var o = Object.freeze({
          ...
          from: function (e) {
            return (
              ...
              o.isPrototypeOf(e) ? e : o.create({ type: "string", data: e })
            );
          },
        });
        return o;
      ...
      function (e, h, s, m) {
        ...
        var c = Object.freeze({
          ...
          apply: function (e, t) {
              ...
              if (e) {
                ...
                if ("datatype" in e && "varRef" in e)
                  return (
                    ...
                    m.containsError(n)
                      ? n
                      : ((r = n.defineType(e.datatype)),
                        m.containsError(r) ||
                        ((r = n.set(t)), m.containsError(r))
                          ? r
                          : void 0)
                  );
                s[e.getName()] = t;
            ...
            var s =
                (s = t.tempVariables) ||
                Object.create(e.stack.length ? e.stackTop.tempVariables : h),
        ...
        var i = e.typeName,
          ...
          u = e({
            ...
            get TwineScript_ObjectName() {
              ...
              return "the "
                .concat(e.length < 24 ? e + "-" : "", "typed variable name, ")
            ...
            TwineScript_ToSource: function () {
              return (
                n(this.datatype) + "-type " + this.varRef.TwineScript_ToSource()
              );
            },
            TwineScript_GetProperty: function (e) {
    ...
    define(
      ...
      function (u, e, t, p, n) {
        ...
        return function (e, t, n, r) {
          ...
          for (
            var a = h(e, "", t || "macro"), o = [], i = "", s = a, c = a.start;
            c < a.end;
            c += 1
          ) {
            var l = a.pathAt(c);
            l[0] !== s[0] &&
              ...
              o.push(
                u(
                  "<"
                    .concat(r && n <= c && c < r ? "mark" : "span", ' class="')
                    .concat(
                      (function (e) {
          ...
          K = function (e, t) {
              ...
              n(function (e) {
                  ...
                  c.toCode || c.toDesc || c.error || c.lambda
                    ? (o
                      ...
                      c.error
                        ...
                        : c.lambda
                        ? ((s = function (e, t) {
                            return I("<".concat(e, "><code></").concat(e, ">"))
                              .find("code")
                              .append(B(t, "macro"))
                              .end();
                          }),
                                ...
                                [
                                  I("<tr>").append(
                                    ...
                                    c.lambda.obj.loop
                                      ? s(
                                          "th",
                                          "_" + c.lambda.obj.loop.getName()
                                        ).append(
                                          " / ",
                                          I("<code>").append(B("it", "macro"))
                                        )
                                      : s("th", "it"),
                                    c.lambda.obj.making &&
                                      s(
                                        "th",
                                        "_" + c.lambda.obj.making.getName()
                                      ),
                                    c.lambda.obj.where &&
                        ...
                        : c.toDesc ||
                          t.find(".to-code").append(B(c.toCode, "macro")),
                      t
                        .next()
                        .html(
                          c.itIdentifier
                    ...
                    : (n.html(B(c.code, "macro")),
                      t
                        ...
                        .empty()),
                    c.lambda ||
                      t.find("code").first().append(B(c.fromCode, "macro")),
                ...
                t &&
                  ...
                  (o = I(
                    "<tw-eval-replay>"
                      .concat(
                        1 === r.length ? "" : "<tw-eval-code></tw-eval-code>",
                ...
                t &&
                  ((s = V.options.ignoreGotos),
                  (V.options.ignoreGotos = !1),
                  t.command.TwineScript_Run(t.section),
                  (V.options.ignoreGotos = s)),
                  e.stopPropagation();
              })
            ),
            ...
            function g(e) {
              (e = e.parents(".variable-row, .enchantment-row, .source-row"))
                ...
                .append(
                  B(
                    e.data("value") || G(e.data("enchantment").changer),
            ...
            var v,
              ...
              S = W.create({
                ...
                rowWrite: function (e, t) {
                  var n,
                    ...
                    l =
                      $(i) && i.TwineScript_DebugName
                        ? i.TwineScript_DebugName()
                        : f(U(i)),
                    u = "",
                    a =
                      (o.length &&
                    ...
                    ? ((t[0].firstChild.innerHTML = a || ""),
                      u &&
                        I(t[0].firstChild)
                          ...
                          .html((s ? "_" : "$") + f(u)),
                      (t[0].childNodes[1].lastChild.textContent =
                        (u ? "" : s ? "_" : "$") + f(r + "")),
                    ...
                    : I('<div class="variable-row">')
                        ...
                        .append(
                          ...
                          "<td class='variable-name cm-harlowe-3-" +
                            ...
                            f(r + "") +
                            "</td>",
                          "<td class='temporary-variable-scope'>".concat(
                            s || "",
                            "</td>"
                          ),
                ...
                rowCheck: function (e, t) {
                  ...
                  return (
                    t[0] &&
                    t[0].getAttribute("data-name") === n &&
                    t[0].getAttribute("data-path") === r + "" &&
                    t[0].getAttribute("data-scope") === e
                  );
                },
                columnHead: function () {
                ...
                rowSort: function (e, t, n) {
                  if ("variable-value" === e)
                    return (
                      ...
                      a(t.parent().data("value"), n.parent().data("value"))
                    );
                },
              }),
              T = l(function () {
                ...
                for (e in n)
                  e.startsWith("TwineScript") ||
                    ...
                    (function n(e) {
                      ...
                      tempScope: "",
                      type:
                        null == (t = n.TwineScript_TypeDefs) ? void 0 : t[e],
                    }));
                o.push.apply(o, _toConsumableArray(k)),
                  (r += k.size),
                  S.update(o, r),
                  (0 === r) !==
                    S.panel[0].classList.contains("panel-variables-empty") &&
                    S.panel.toggleClass("panel-variables-empty");
              }),
              _ =
              ...
              x =
                (r.on("click", ".panel-variables-copy", function () {
                  ...
                  for (e in D.variables)
                    e.startsWith("TwineScript") ||
                      t.push("$" + e + " to " + G(D.variables[e]));
                  _.val("(set:" + t + ")")[0].select(),
                          ...
                          "<td><span class='enchantment-name'>" +
                            ...
                            (i
                              ? "</span><span class='enchantment-local cm-harlowe-3-hookName'>" +
                                ("function" == typeof i.TwineScript_ToSource
              ...
              A = W.create({
                ...
                rowWrite: function (e, t) {
                  ...
                  return (
                    t
                      ? (t.toggleClass("storylet-closed", !r),
                        (t[0].firstChild.textContent = r ? "\u2713" : ""))
                      : (t = I(
                      ...
                      ? t
                        ...
                        : I(
                            '<span><input id="debug-'
                              .concat(
                                n,
                                '" type="checkbox"></input><label for="debug-'
                              )
                              .concat(n, '">')
                              .concat(a, "</label></span>")
                          )
                      ...
                      ? t
                        ...
                        : I(
                            "<span>"
                              .concat(
                                a,
                                '<select style="width:3em" data-default="'
                              )
                              .concat(i, '" id="debug-')
                              .concat(n, '"></span>')
                          )
              ...
              P =
                (r.on(
                  "click, change",
                  '.panel-tools [type="checkbox"], .panel-tools select',
                  function (e) {
                    var e = e.target,
                      t = (e = I(e)).attr("id"),
                      n =
                        e.is(":checked") ||
                        (e.is("select") && e.val() !== +e.attr("data-default"));
                    "debug-peekBehindDialogs" === t &&
                      r.toggleClass("debug-dialogs", n),
                      "debug-ignoreClickEvents" === t &&
                        (V.options.ignoreClickEvents = n),
                      "debug-ignoreGotos" === t && (V.options.ignoreGotos = n),
                      "debug-speedMultiplier" === t &&
                        (V.options.speedMultiplier = +e.val()),
                      j.tabUpdate(n);
                  }
                ),
                j.update([
                  {
                    ...
                    type: "checkbox",
                    label:
                      "See through and click through <code>(dialog:)</code> boxes",
                  },
                  {
                    id: "ignoreClickEvents",
                    type: "checkbox",
                    label:
                      "Stop links, <code>(click:)</code> and <code>(hover-style:)</code> from activating",
                  },
                  {
                    id: "ignoreGotos",
                    type: "checkbox",
                  ...
                  },
                  {
                    id: "speedMultiplier",
                    label:
                      "Speed of timed events (<code>time</code>, <code>(live:)</code>, <code>(after:)</code>): ",
                    type: "dropdown",
                    dropdownValue: 1,
                    dropdownItems: [
                      0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 3, 5, 10,
                    ],
                  },
                ]),
                W.create({
                ...
                (r.on(
                  ...
                  function (e) {
                    var e = e.target,
                      ...
                      e = e.is(":checked");
                    "debug-darkMode" === t &&
                      ((o.darkMode = e), h.toggleClass("theme-dark", e)),
                      "debug-fadePanel" === t &&
                        ((o.fadePanel = e), h.toggleClass("fade-panel", e)),
                      "debug-evalReplay" === t &&
                        (V.options.evalReplay = o.evalReplay = e),
                      c();
                  }
                ),
                P.update([
                  ...
                  T(),
                    ...
                    D.passage &&
                      ...
                      C.panel
                        ...
                        .insertBefore(
                          C.panel.find('[data-tag="footer"]').first()
                        ));
                }));
            D.on("forward", R).on("back", R).on("load", R);
            (K = b),
              I(document.head).append(I("<style>").html(X)),
              b(),
              e && d(e, t);
          };
        return (
            ...
            e =
              (e.forEach(function (t) {
                var e = c.get().filter(function (e) {
                  ...
                  n = a(t, e.length && d(e));
                e.length || o.append(n),
                  s.push.apply(s, _toConsumableArray(n.get()));
              }),
              c
                .filter(function (e, t) {
          ...
          return (
            ...
            .reduce(function (e, t, n, r) {
              ...
              return e.concat(
                ...
                n !== r - 1 &&
                  document.createElement(t.length ? "br" : "tw-consecutive-br")
              );
            }, []);
        }
        var k = e.impossible,
            ...
            update: function () {
              ...
              if (
                ...
                for (var c = 0; c < s.length; c += 1)
                  v.isPrototypeOf(s[c]) ? s[c].forEach(t, e) : e(s[c]);
                ...
                ([]
                  ...
                  .map(function (e) {
                    ...
                    return (
                      e.target &&
                        e.append &&
                        ((r = (t = e).append), (n = t.before), (e = e.target)),
                      {
                      ...
                      : (e.replaceWith(
                          w
                            .create(
                              "macrocall",
                              'The lambda "'
                                .concat(S(f), '" must return a changer, not ')
                                .concat(k(o), ".")
                            )
                            .render()
                        ),
                          ...
                          return (
                            "background-color" === t || "background-image" === t
                              ? ((e["background-color"] = "transparent"),
                                ...
                                a.push(
                                  "background-".concat(
                                    "background-color" === t ? "image" : "color"
                                  )
                                ))
                              : (e[t] = "inherit"),
                            e
      ...
      var a = s.impossible,
        ...
        l =
          (i(document.documentElement).on("click", "tw-folddown", function (e) {
            ...
            for ("function" == typeof e && e(t); t && !t.next().length; )
              t = t.parent();
              ...
              r =
                ...
                i(
                  "<tw-error class='" +
                    ...
                    c(t) +
                    "'>" +
                    c(this.message + (this.appendTitleText ? " " + t : "")) +
                    "</tw-error>"
                )),
    ...
    define("internaltypes/twinenotifier", ["jquery", "utils"], function (e, t) {
      var n = t.impossible,
        r = {
          create: function (e) {
            return (
              e || n("TwineNotifier.create", "called with only 1 string."),
      ...
      function (u, p, e, t, i) {
          ...
          if (h(e))
            ...
            if (!["length", "some", "any", "all"].includes(t))
              return p.create(
                "property",
                ""
                  .concat(T, "'length', 'some', 'any', and 'all' of ")
                  .concat(m(e), "."),
          ...
          return void 0 === e
            ...
            ? ("string" == typeof e &&
                (C.has(e)
                  ? (e = C.get(e))
                  : A.test(e)
                  ? ((a = _toConsumableArray(e)), C.set(e, a), (e = a))
                  : C.set(e, e)),
              h(e) && Number.isFinite(t) && (t = O(e, t)),
              e.TwineScript_GetProperty
                ? e.TwineScript_GetProperty(t)
        ...
        function P(t, e, n, r) {
          ...
          t instanceof Map
            ? t.set(e, n)
            : (h(t) && (e = O(t, e)),
              t.TwineScript_Set ? t.TwineScript_Set(e, n, r) : (t[e] = n)),
        ...
        function I(t, e) {
          ...
          return e && "object" === _typeof(e) && "last" in e && "first" in e
            ...
            ? 0
            : "temp" ===
              (null == (r = t.TwineScript_VariableStore) ? void 0 : r.type)
            ? p.create(
                "property",
            ...
            ? p.create(
                ...
                "This array of "
                  ...
                  .concat(N(a + ("number" == typeof a ? 1 : "")), " element."),
                t.length
            ...
            : ((o = Array.from("function" == typeof t.keys && t.keys())),
              p.create(
                "property",
                "I can't find a ".concat(N(a), " data name in ").concat(m(t)),
                t instanceof Map && o.length
                  ? "Its names include: ".concat(s(o), ".")
                  : void 0
              ));
        }
        function V(e, t) {
            ...
            e = this.compiledPropertyChain
              .reduce(function (e, t) {
                var n =
                  0 === e.length
                    ? r.object
                    : I.apply(void 0, _toConsumableArray(e[e.length - 1]));
                return e.push([n, t]) && e;
              }, [])
              .reduceRight(e, t);
        ...
        return (c = Object.freeze({
          get: function () {
            for (
              ...
              if (
                ((e = I(e, this.compiledPropertyChain[t])), p.containsError(e))
              )
                return e;
            return I(
              e,
            ...
            return !this.object ||
              ...
              ? V.call(
                  ...
                  function (n, e, t) {
                    ...
                    if (
                      (e =
                        p.containsError(n, r, a) || p.containsError(j(r, a, n)))
                    )
                      return e;
                    if ((e = w(n)))
                      return p.create(
                ...
                return (
                  ...
                  null === e
                    ? ((r = "string" == typeof a) &&
                      ...
                      k(t)
                        ? (h(a) &&
                            (t = _toConsumableArray(new Set(t))).sort(function (
                              e,
                              t
                            ) {
                              return O(a, t) - O(a, e);
          ...
          on: function (e, t) {
            if (e in S)
              return (
                "function" != typeof t || S[e].includes(t) || S[e].push(t), c
              );
    ...
    define(
      ...
      function (u, n, b, c, l, a, y, M, e, o, t, p, d, i, s, v, r, f) {
        ...
        ["set", "put", "unpack"].forEach(function (r) {
                  ...
                  return y.create(
                    ...
                    "unpack" === r
                      ...
                      : "Please use the ("
                          ...
                          .concat(
                            "set" === r ? "left of 'to'." : "right of 'into'."
                          ),
          ...
          n.addCommand(
            ...
            function (e) {
              if (!l.hasValid(e))
                return y.create(
                  "macrocall",
                  "I can't (display:) the passage '".concat(
                    e,
            ...
            function (e) {
              if (
                "command" === (null == e ? void 0 : e.TwineScript_TypeID) &&
            ...
            function (e, t, n) {
              ...
              return t && t.trim()
                ? "string" != typeof n || n.trim()
                  ? void 0
                  : y.create("datatype", "The 2nd " + r)
                : y.create("datatype", "The 1st " + r);
            },
            function (r, e, a, o, i) {
              ...
              return "number" != typeof t
                ...
                : C(r, {
                    source: '<tw-icon data-label="'
                      .concat(
                        b.escape(1 !== j(t) && void 0 !== i ? i : o),
                        '">'
                      )
                      .concat((0 < t ? E : N)(t), "</tw-icon>"),
                  });
            },
            [v, String, x(String)]
          ),
              ...
              var t = S(t),
                ...
                t =
                  ((r.data.twoWayBindEvent = function (e, t, n) {
                    a.varRef.matches(t, n) &&
                      "number" == typeof (t = a.varRef.get()) &&
                      ((n = r.target.children("tw-meter")).attr("style", s(t)),
                      o) &&
          ...
          [["cycling-link"], ["seq-link", "sequence-link"]].forEach(function (
            t,
            u
          ) {
            return n.addCommand(
              ...
              function () {
                ...
                return "" === (arguments.length <= 0 ? void 0 : arguments[0])
                  ? y.create(
                      "datatype",
                      "The first string in a (" + t[0] + ":) can't be empty."
                    )
                  : arguments.length <=
                    (v.isPrototypeOf(
              ...
              function (a, e) {
                ...
                var s = 0,
                  c =
                    ("two way" === (null == (l = o) ? void 0 : l.bind) &&
                      (a.attr.push({ "data-2bind": !0 }),
                      -1 < (l = i.indexOf(o.varRef.get()))) &&
                      (s = l),
                  ...
                  var n = s >= i.length - 1 && u,
                    r =
                      "" === i[s]
                        ...
                        : n
                        ? i[s]
                        : "<tw-link>".concat(i[s], "</tw-link>");
                  if ((n && (a.data.clickEvent = void 0), o && !t)) {
                    n = o.set(i[s]);
                    if (y.containsError(n))
                      return void e.replaceWith(n.render(i[s]));
                  }
                  t = _objectSpread(
                    _objectSpread({}, a),
                    {},
                    { source: r, transitionDeferred: !1 }
                  );
                ...
                i[s] &&
                  ...
                  (a.data.twoWayBindEvent = function (e, t, n) {
                    o.varRef.matches(t, n) &&
                      ((t = o.varRef.get()), -1 < (n = i.indexOf(t))) &&
                      n !== s &&
                      ((s = n), r(e, !0));
                  }));
                  ...
                  a
                    .map(function (e, t) {
                      return "<option"
                        .concat(t === i ? " selected" : "")
                        .concat("" === e ? " disabled" : "", ">")
                        .concat(b.escape(e || "\u2500".repeat(s)), "</option>");
                    })
                    .join("\n") +
                  "</select>",
                l =
                  ...
                  (e.data.twoWayBindEvent = function (e, t, n) {
                    r.varRef.matches(t, n) &&
                      ((t = r.varRef.get()), -1 < (n = a.indexOf(t))) &&
                      n !== i &&
        ...
        n.addCommand(
                ...
                ("two way" === r.bind &&
                  ...
                  (e.data.twoWayBindEvent = function (e, t, n) {
                    r.varRef.matches(t, n) &&
                      ...
                      e.children("input[type=checkbox]").prop("checked", t);
                  })),
          ...
          b.onStartup(function () {
            return u(document).on("fullscreenchange", function () {
              u("input[type=checkbox][id^=fullscreen]", b.storyElement).each(
                function (e, t) {
                  (
          ...
          ["input", "force-input", "input-box", "force-input-box"].forEach(
            function (g) {
              return n.addCommand(
                g,
                function () {
                ...
                g.endsWith("box")
                  ? [_(v, String), x(_(A, String)), x(_(A, String)), x(String)]
                  : [x(_(v, String)), x(String), x(String)]
              );
            }
          ),
        ...
        n.addCommand(
                  ...
                  null !=
                    (t = (n = r =
                      ...
                      r.scrollHeight === r.clientHeight
                        ? getComputedStyle(document.body).overflow.includes(
                            " scroll"
                          )
                          ? document.body
                          : document.documentElement
                        : r).scrollTo) &&
                    t.call(n, 0, (r.scrollHeight - r.clientHeight) * y);
                } else {
                  var a,
                    o = _createForOfIteratorHelper(g.hooks(m).get());
                  try {
                    for (o.s(); !(a = o.n()).done; ) {
                      var i = a.value;
                      if (e.find(i)) {
                        for (
                          ...
                          s.push([c, c.scrollLeft, c.scrollTop]);
                        i.scrollIntoView();
                      ...
                      buttons: [
                        {
                          ...
                          confirm: !0,
                          callback: function () {
                            "delete" === r.find("input").last().val() &&
                              localStorage.removeItem(R("Saved Game") + t),
                              e.unblock("");
                          },
                        },
                        {
          ...
          function (e, n, r, t) {
            for (
              var a = arguments.length, o = new Array(4 < a ? a - 4 : 0), i = 4;
              i < a;
              i++
            )
              o[i - 4] = arguments[i];
          ...
          function () {
            if (!b.options.ignoreGotos) {
              ...
              c.hasSessionStorage && sessionStorage.removeItem("Saved Session"),
                window.location.reload();
            }
          },
          [],
            ...
            for (t = 0; t < a.length; t += 1) {
              ...
              if (!i) {
                ...
                if (n.includes(s))
                  return f.create(
                    "datatype",
                    i + "'s typed variables can't both be named '" + s + "'."
                  );
                n.push(s);
              }
            }
            ...
            function (e, t) {
              if (e.section) {
                ...
                for (n in o.tempVariables)
                  n.startsWith("TwineScript_") || (i[n] = o.tempVariables[n]);
                s("output", a, {
                  changer: t,
                  variables: i,
    ...
    define(
      ...
      function (e, i, t, n, s, r, a, c, o, l) {
        ...
        t.add(
          ...
          function (e) {
            ...
            if (!c.isPrototypeOf(r[0]))
              return (t = r.filter(function (e) {
                ...
                : r.sort(_);
            var o = r.shift();
            if ("making" in o || "where" in o || "when" in o || !("via" in o))
              return l.create(
                "datatype",
          ...
          function (n, r) {
            for (
              var e = arguments.length, t = new Array(2 < e ? e - 2 : 0), a = 2;
              a < e;
              a++
            )
              t[a - 2] = arguments[a];
          ...
          function (r, a) {
            for (
              var e = arguments.length, t = new Array(2 < e ? e - 2 : 0), n = 2;
              n < e;
              n++
            )
              t[n - 2] = arguments[n];
            return (
              "where" in a &&
                (t = [t[0]].concat(
                  _toConsumableArray(a.filter(r, t.slice(1)))
                )),
              l.containsError(t) ||
          ...
          function () {
            ...
            do {
              ...
              (null != (n = t) &&
                n.startsWith(o) &&
                ((t = t.slice(o.length)),
                a.set(t, localStorage.getItem(e("Saved Game Filename") + t))),
              t)
            );
            return a;
          },
          ...
          function t(n, r) {
            ...
            switch (h(r)) {
              ...
              default:
                return l.create(
                  "macrocall",
                  d(r) + " can't contain values, let alone " + d(s) + "."
                );
            }
          },
          [T, w(T)]
      ...
      function (c, r, e, l, s, n, u, p, a, d, t, i, f, h) {
          ...
          return (
              ...
              r.storyElement.on(
                ...
                function () {
                  var e,
                    t = c(this);
                  (r.options.debug &&
                    r.options.ignoreClickEvents &&
                    !t.is(
                      "tw-backdrop.eval-replay *, tw-backdrop.harlowe-crash *"
                    )) ||
                    t.is("tw-open-button") ||
                    ((e = (t = c(
            ...
            [
              ...
              function (t, e, n) {
                ...
                return (
                  t.section && (t.section.addEnchantment(o), o.enchantScope()),
                  t
                );
              },
          ...
          u.addChanger(
            ...
            function (e) {
              ...
              return n.every(Boolean)
                ...
                : h.create(
                    "datatype",
                    "A string given to this (".concat(o, ":) macro was empty.")
                  );
            },
            function (e) {
              var t;
              0 <
                c(e.target).parents().filter("tw-collapsed,[collapsing=true]")
                  .length ||
        ...
        S.forEach(function (e) {
          "doubleclick" !== e.name &&
            (u.addChanger.apply(
              u,
              [e.name].concat(_toConsumableArray(w(e.enchantDesc, e.name)))
            ),
            "click" === e.name) &&
            u.addChanger.apply(
              u,
                ...
                r.storyElement.on(
                  ...
                  function () {
                    ...
                    (r.options.debug &&
                      ...
                      ((e = (t = c(
                        Array.from(
                          t.parents("." + n.blockClassList.replace(/ /g, "."))
                        ).sort(function (e, t) {
                          return 8 & e.compareDocumentPosition(t) ? 1 : -1;
                        })[0]
                      )).data("enchantmentEvent")) &&
          ...
          e.forEach(function (n) {
            S.forEach(function (e) {
              ...
              "doubleclick" !== e &&
                ...
                (e = e.name + "-" + n),
                u.addChanger.apply(u, [e].concat(_toConsumableArray(w(t, e)))));
            });
          }),
                ...
                u.addCommand(
                  ...
                  function (e, t) {
                    return !e || (!t && "goto" === a)
                      ? h.create(
                          "datatype",
                          "A string given to this (" + o + ":) macro was empty."
                        )
                      : "goto" !== a || n.hasValid(t)
                      ? void 0
                      : h.create(
          ...
          function t(e) {
            ...
            if (
              ...
              (null == r ||
                !r.stackTop ||
                !r.stackTop.blocked ||
                (r.stackTop.blocked instanceof i &&
                  r.stackTop.blocked.find(t).length))
            ) {
              if (a)
                return 0 < t.find("tw-error").length
                  ? void 0
                  : (e.stopPropagation(), void a(t));
              ...
              if (s)
                (s = s.get("name")),
                  ...
                  (c =
                    c ||
                    "<tw-link tabindex=0 " +
                      (0 < l.passageNameVisited(s) ? 'class="visited" ' : "") +
                      ">" +
                      r +
                      "</tw-link>"),
    ...
    define(
      ...
      function (e, t, n, y, b, h, v, w) {
                ...
                if (!l)
                  return v.create(
                    ...
                    "Optional string patterns, like ("
                      .concat(a, ":)")
                      .concat(
                        "p-many" === a ? " with a minimum of 0 matches" : "",
                        ", can't have typed variables inside them."
                      )
                  );
                if (!p && !w.isPrototypeOf(n.object))
                  return v.create(
                    "operation",
                ...
                return d.reduce(function (e, t) {
                  return (
                    h.isPrototypeOf(t) &&
                      ...
                      (t = t.datatype)),
                    (e =
                      b.isPrototypeOf(t) && "function" == typeof t.typedVars
        ...
        e.add(
          ...
          function (e, t, n) {
            return void 0 === n ||
              (b.isPrototypeOf(t) && "whitespace" === t.name)
              ? t.trim()
              : ((t = k({
                  name: "trimmed",
                  fullArgs: [t],
          ...
          function (e, t, n, r, a) {
            ...
            if (y.isPrototypeOf(a) || y.isPrototypeOf(n))
              return v.create(
                "datatype",
                "The ".concat(
                  y.isPrototypeOf(a) ? "final string" : "search pattern",
            ...
            for (
              var o,
                i = RegExp(n.regExp, "g"),
                s = y.isPrototypeOf(r) ? n.typedVars() : [],
                c = 1,
                l = 0,
                u = "",
                p = i.lastIndex;
              ...
              if ("string" != typeof g)
                return v.create(
                  ...
                  "(str-replaced:)'s lambda must produce a string, but it produced "
                    .concat(O(g), ' when given "')
                    .concat(o[0], '".')
                );
              (u += a.slice(l, o.index) + g),
                (c += 1),
                --t,
          ...
          [
            r(t, String, b),
            r(b, String, y.TypeSignature("via")),
            r(String, y.TypeSignature("via")),
            a(String),
          ]
        );
      }
      ...
      function (s, e, c, t, a, n, r, o, i, l, u) {
        ...
        e
            ...
            function (n) {
              ...
              n.data.errorEvent = function (e) {
                ...
                var t = _objectSpread(
                  _objectSpread({}, n),
                  {},
                  { enabled: !0, transitionDeferred: !1 }
                );
                ...
                "zoom" === (e.transition = t) &&
                  (e.transitionOrigin = function () {
                    var e = s(this).offset(),
                      ...
                      e = e.top;
                    return (
                      c.mouseCoords.x - t + "px " + (c.mouseCoords.y - e) + "px"
                    );
                  }),
                e
              );
          ...
          .apply(
                  ...
                  return (
                    e.attr.push({
                      class: function () {
                        var e = (function e(t) {
                          return (
                            (t = s(t)).is("tw-story, tw-sidebar, tw-passage") ||
                            ["block", "flex"].includes(t.css("display")) ||
            ...
            [g(String, a)].concat(
              _toConsumableArray(Array(3).fill(b(g(String, a))))
            )
          )(
            "opacity",
            function (e, t) {
            ...
            function (e, t) {
              return (
                a.isPrototypeOf(t)
                  ? (t = t.toRGBAString())
                  : r.isPrototypeOf(t) && (t = t.toLinearGradientString()),
                (t =
                ...
                e.styles.push(t, {
                  display: function () {
                    var e = s(this);
                    return !e.children().length || c.childrenProbablyInline(e)
                      ? s(this).css("display")
                      : "block";
                  },
                }),
          ...
          ["box", "float-box"].forEach(function (i) {
            return e.addChanger(
              ...
              function (e, t, n) {
                var r =
                    -1 === t.search(h) || (1 < t.length && !t.includes("=")),
                  a =
                    "float-box" === i &&
                    (-1 === n.search(h) || (1 < n.length && !n.includes("=")));
                return r || a
                  ? u.create(
                      "datatype",
                      "The (" +
              ...
              function (e, t, n) {
                ...
                return (
                  void 0 !== n &&
                    (t.height = "box" === i ? 1.5 * n + 2 + "em" : n + "vh"),
                  "float-box" === i &&
                    m(t, {
                      position: "fixed",
                      top: r + "vh",
    ...
    define(
      ...
      function (t, r, e, n, l, c, a, o, i, f) {
        ...
        t.add(
          ...
          "String",
          function (e, t) {
            return "command" !== (null == t ? void 0 : t.TwineScript_TypeID) ||
              t.TwineScript_ToSource
              ? y(t)
              : f.create(
                  "datatype",
    ...
    !function () {
          ...
          for (
            ...
            if (
              !(
                ...
                (h.cannotFollowText &&
                  ("text" === (null == (w = l) ? void 0 : w.type) || s < i))
              ) &&
              ...
              if (m.matches) {
                for (; o && y < o.length; y += 1) {
                  ...
                  b && (v = b),
                    -1 <
                      (null == (b = m.cannotCross) ? void 0 : b.indexOf(v)) &&
                      (y = o.length - 1);
                }
              ...
              var s = (i += (l = e.addChild(m)).text.length),
                w = !1;
              g && (t && S(e, l, o[y]), (o = o.slice(y + 1)), (w = !0)),
      ...
      (o.prototype = {
        ...
        lastChildEnd: function () {
          var e =
            (this.children && this.children[this.children.length - 1]) || null;
          return e
            ? e.end
            ...
            if (r.matches)
              for (var o = 0; o < e.length; o += 1)
                e[o].type in r.matches &&
                  (S(this, r, e[o]), (e = e.slice(o + 1)), (a = !0));
      ...
      function t(e) {
        ...
        var i = [],
          ...
          l = a(i, {
            ...
            align: {
              fn: function (e) {
                ...
                return (
                  ~n
                    ? 25 === (t = Math.round((n / (e.length - 2)) * 50)) &&
                      (t = "center")
                    : "<" === e[0] && ">" === e.slice(-1)
                    ? (t = "justify")
                    : -1 < e.indexOf(">")
          ...
          h =
            (i.push.apply(
              i,
              _toConsumableArray(g(l)).concat(
                _toConsumableArray(g(p)),
                _toConsumableArray(g(u))
              )
            ),
            s.push.apply(
              s,
              _toConsumableArray(g(p)).concat(_toConsumableArray(g(d)))
            ),
            c.push.apply(c, _toConsumableArray(g(f))),
            _objectSpread(
              _objectSpread(
                _objectSpread(_objectSpread(_objectSpread({}, l), u), p),
                d
              ),
              f
            )),
          u =
            (g(h).forEach(function (e) {
              m.PlainCompare[e]
                ? ((h[e].pattern = m.PlainCompare[e]), (h[e].plainCompare = !0))
    ...
    !function () {
      ...
      (g.main =
        g.opener +
        r(
          g.text + g.rightSeparator,
          g.text.replace("*", "*?") + g.leftSeparator
        ) +
        g.text),
        (e = {
        ...
        function h(a) {
          return function (e, t) {
            ...
            return (
              ...
              i(e) !== i(t)
                ? ((n = ""
                    .concat(g(e), " isn't the same type of data as ")
                    .concat(g(t))),
            ...
            "/": f(
              ...
              h(function (e, t) {
                return 0 === t
                  ? m.create(
                      "operation",
                      "I can't divide ".concat(g(e), " by zero.")
                    )
                  : e / t;
              }),
              "divide"
            ...
            "%": f(
              ...
              h(function (e, t) {
                return 0 === t
                  ? m.create(
                      "operation",
                      "I can't modulo ".concat(g(e), " by zero.")
                    )
                  : e % t;
              }),
              "modulus"
        ...
        return function run(section, tokens) {
          ...
          1 === tokens.length
            ...
            : ((_precedentToken = precedentToken(tokens, "least")),
              ...
              (before.length &&
                (1 !== before.length || "whitespace" !== before[0].type)) ||
                (before = !1),
              (after.length &&
            ...
            VARREF =
              ("both" !== sides || (before && after)
                ? "neither" === sides && (before || after)
                  ...
                  : "after" === sides &&
                    (after
                      ? before && (ret = wrongSideError(before, null, token))
          ...
          if (!ret) {
            if ("comma" === type)
              return (
                impossible("Section.run", "a comma token was run() somehow."), 0
              );
            if ("root" === type) ret = run(section, token.children);
            else if ("identifier" === type)
              ret = isVarRef
                ? VarRef.create(section.Identifiers, token.text.toLowerCase())
              ...
              var datatype = run(section, before),
                ...
                variable =
                  ((section.freeVariables = null), run(section, after, VARREF));
              ...
              var isComparisonOp = function e(t) {
                ...
                getElisionOperands = function e(t) {
                  ...
                  return a && "whitespace" !== a.type
                    ? a.type === type
                      ? [].concat(
                          _toConsumableArray(e(t.slice(0, r))),
                          _toConsumableArray(e(t.slice(r + 1)))
                        )
                      : ((a = run(section, t)),
                        hasEvalReplay &&
                          "boolean" != typeof a &&
                          ...
                          makeEvalReplayFrame(evalReplay, {
                            toCode: " it "
                              ...
                              .concat(toSource(a), " "),
                            reason: "A missing 'it "
                              .concat(n, "' was inferred to correct the '")
              ...
              before &&
                ...
                (convert =
                  ("both" === _sides ||
                    ...
                    "addition" === pType ||
                    "subtraction" === pType) &&
                  (_i10 === before.length - 1 ||
                    (_i10 === before.length - 2 &&
              ...
              "random" === value &&
                ...
                (ret =
                  isVarRef || TwineError.containsError(ret) ? ret : ret.get()),
                "belongingItOperator" === type &&
                  hasEvalReplay &&
                  makeEvalReplayFrame(evalReplay, {
                    toCode: " "
      ...
      return function (h) {
        ...
        return function (e, t) {
          ...
          for (var d = 0, f = Math.max(u.length, p.length); d < f; d++) {
            if (
              ((n = (!(u[d] || "").match(l) && parseFloat(u[d])) || u[d] || 0),
              (r = (!(p[d] || "").match(l) && parseFloat(p[d])) || p[d] || 0),
              isNaN(n) !== isNaN(r))
            )
              return isNaN(n) ? 1 : -1;
            if (_typeof(n) !== _typeof(r)) (n += ""), (r += "");
            else if ("string" == typeof n && a && 0 !== (o = a.compare(n, r)))
              return o;
            if (n < r) return -1;
            if (r < n) return 1;
          }
    ...
    define(
      "utils/operationutils",
      ["utils/naturalsort", "utils", "internaltypes/twineerror", "patterns"],
      function (f, e, h, t) {
        var m = e.impossible,
          g = e.nth,
          u = e.permutations,
        ...
        function l(e) {
          ...
          return a(e) && "TwineScript_ObjectName" in e
            ...
            ? 0 === e.size
              ? "an empty datamap"
              : "a datamap (with " +
                o(_toConsumableArray(e.keys()), 48, "dataname", _) +
                ")"
            : e instanceof Set
            ? 0 === e.size
              ? "an empty dataset"
              : "a dataset (with " +
                o(_toConsumableArray(e.values()), 48, "item", l) +
                ")"
            : _typeof(e) === b
            ? 0 === e.length
              ? "an empty string"
        ...
        function _(e, t) {
          ...
          if (S(e) && "first" in e && "last" in e)
            return (
              (e.first < 0
                ? (-1 !== e.first ? g(-e.first) : "") + "last"
                : g(e.first + 1)) +
              "to" +
              (e.last < 0
                ? (-1 !== e.last ? g(-e.last) : "") + "last"
                : g(e.last + 1))
            );
          if (k(e)) {
            var r,
            ...
            if (e || "" === e) {
              if (_typeof(e) === b)
                return _typeof(t) !== b
                  ? h.create(
                      "operation",
                      l(e) + " can only contain strings, not " + l(t) + "."
                    )
                  : e.includes(t);
              if (k(e))
        ...
        function d(e, t, n) {
          ...
          if (!(a <= t))
            return (
              ...
              n && (n = n <= 0 ? a - n : n) < a && r.push(e.splitText(n - t)),
              r
            );
        }
        var t,
            ...
            return (
              ...
              t
                ? (t.renderInto(
                  ...
                  null !=
                    ...
                    n.length &&
                    n.appendTo(s).append(c.prepend(n.contents().detach())))
                : c.prepend(p.exec(a)),
              o &&
                ((e = s.find("input").last())
                  .val(o)
              ...
              i.reverse().forEach(function (e, t) {
                l(s.find("tw-link").get(-t - 1)).on("click", function () {
                  (u.options.debug &&
                    u.options.ignoreClickEvents &&
                    !l(s).is(".eval-replay, .harlowe-crash")) ||
                    (s.remove(), e.callback());
                });
              }),
              s
              ...
              return Object.keys(this).reduce(function (e, n) {
                ...
                return (
                  "toString" !== n &&
                    ...
                    (e += r.join(", ") + "{" + a[n] + "}"),
                    a[n].match(i)) &&
                    [".theme-dark", "[data-app-theme=dark]"].forEach(function (
                      t
                    ) {
                      e +=
                        r
